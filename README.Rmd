...
> The `pybats-detection` is a `python` package with routines for detection of outlier and structural changes in time series using Bayesian Dynamic Linear Models (DLM).
