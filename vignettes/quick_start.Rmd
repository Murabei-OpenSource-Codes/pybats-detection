...
knitr::opts_chunk$set(
   ...
   dev = "png", fig.align = "center", fig.width = 16,
...
```{python}
monitor = Monitoring(mod=mod, bilateral=True, prior_length=40)
```

## Step 6: Use the method `fit`

```{python fit-monitor}
results = monitor.fit(y=telephone_calls["average_daily_calls"], h=4,
                      tau=0.135, change_var=[6, 2], type="location",
                      distr="normal", verbose=True)
```
