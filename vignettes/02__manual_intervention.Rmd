...
```{r plot-fit-cp6-filter-intervention, echo=FALSE, fig.cap="Mean response for filtered predictive distribution with $95\\%$ credibility interval and ideal interventions", fig.dim=c(16,9), warnings = FALSE, out.width = "90%"}
